...
export const SP_ON_ERROR = 'SP_ON_ERROR';
export const SP_ON_WRITE = 'SP_ON_WRITE';
export const SP_ON_IS_OPENED = 'SP_ON_IS_OPENED';

export const SP_ON_ACTION_ILLEGAL = 'SP_ON_ACTION_ILLEGAL';
